      ...
      <footer className="flex flex-row mx-auto  items-center justify-center px-4 py-4 shadow-lg  scale-105 bg-opacity-80b bg-dark-blue" >
        <section className="flex space-x-4">
          <a
            ...
            className="text-xl hover:text-light-blue flex justify-center rounded-full bg-pink p-2"
            target="_blank"
          ...
          <a
            ...
            className="text-xl text-gray-700 hover:text-light-blue flex justify-center rounded-full bg-pink p-2"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaLinkedinIn />
